...
<head>
    ...
    <title>Hoja 4 Arrays 1</title>
</head>

<body>
    <div>
        <h3>1. Obtener dos arrays escalares: uno con valores y otro con índices a partir del array de la ficha.</h3>
        <?php
        $alumno = array(
            "nombre" => "José",
    ...
    <div>
        <h3>2. Crea un array de dos dimensiones de manera que en una dimensión contenga el tipo de colores (fuerte o
            suave) y en la otra 3 colores de cada tipo. Visualiza una tabla recorriendo el array.</h3>
    ...
    <div>
        <h3>3b. Array de equipo de fútbol</h3>
        <?php
        $equipo_futbol = array(
    ...
    <div>
        <h3>3d. Array de supermercado</h3>
        <?php
        $supermercado = array(
    ...
    <div>
        <h3>3f. Array de productos actualizado</h3>
        <?php
